...
## 2026-07-17
- **Lệnh "chuẩn bị máy"**: sau khi cài plugin, nhắn "chuẩn bị công cụ dựng video cho máy này" → skill báo trước sẽ tải gì (kho ~180MB + bộ nghe 1.6GB, chạy nền), dò GPU, chốt bằng bảng trạng thái từng mục — hết cảnh cài xong không biết máy mình đủ đồ chưa.
