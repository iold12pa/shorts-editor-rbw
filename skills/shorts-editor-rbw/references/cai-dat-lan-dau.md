...
**Chưa có key vẫn dựng được video Kiểu 1 và Kiểu 2** (hai kiểu này không cần giọng đọc AI): mắt AI Gemini bỏ qua, dùng tầng đo kỹ thuật miễn phí thay thế. **Riêng Kiểu 3 cần key ElevenLabs** — từ 22/07/2026 không còn giọng miễn phí thay thế (edge-tts bị loại vì đọc méo), thiếu key thì báo người dùng xin key.
