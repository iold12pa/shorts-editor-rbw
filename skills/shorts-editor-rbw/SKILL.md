...
> # 📦 BẢN HIỆN TẠI: **Ver 32** — phát hành 24/07/2026
>
...
>
> 📜 **Lịch sử đầy đủ (Ver 0 → hiện tại) đã chuyển sang `VER-HISTORY.md`** (tách 24/07/2026, tối giản SKILL.md — file này được đọc TOÀN BỘ mỗi lần dùng skill nên bảng lịch sử dài ra vô hạn rất tốn token). **KHÔNG cần mở `VER-HISTORY.md` khi dựng video** — chỉ mở khi cần tra "bản nào từng sửa gì".
...
5. Trên máy quản trị: commit đích danh file vừa sửa + **push NGAY, TỰ ĐỘNG — không hỏi "có đẩy không"** (chỉ đạo Sếp Huy 17/07/2026: "học được cái gì là auto đẩy lên"; điểm dừng duy nhất là bước 3 khi luật mới mâu thuẫn luật cũ). Kể cả đang giữa buổi dựng video cũng khắc + đẩy luôn rồi dựng tiếp, đừng để dồn cuối buổi rồi quên. Thêm 1 dòng CHANGELOG nếu luật đáng chú ý → báo lại 1 câu: *"đã khắc luật vào <file>, đã đẩy lên — cả team nhận khi mở lại app"*.
   ...
   🔴 **VÀ TĂNG SỐ Ver** (luật Sếp Huy chốt 22/07/2026) — sửa **2 chỗ**: (1) dòng `📦 BẢN HIỆN TẠI: Ver N` ở đầu `SKILL.md`, và (2) **thêm 1 hàng vào bảng ở `VER-HISTORY.md`** (Ver mới / ngày / số máy đọc / có gì mới — tách khỏi SKILL.md 24/07/2026 để đỡ tốn token đọc mỗi lần dùng skill). Ver tăng **+1 mỗi lần phát hành**, không theo ngày. Cùng một ngày phát hành 2 lần thì là 2 Ver khác nhau. Bỏ bước này thì người dùng vẫn nhận được luật mới nhưng **mọi máy báo sai số bản cho nhau**, không ai biết ai đang chạy gì.
...
0. 🔀 **LUỒNG HỎI PHÂN NHÁNH — Sếp Huy thiết kế 22/07/2026, đây là luồng chính thức.** Hỏi theo nhánh, không dồn hết mọi câu cho mọi người:
   ...
   **Bước 2 — theo nhánh vừa chọn:**
   ...
   🔴 **CÂU MỞ PHẢI LÀ MỘT LƯỢT RIÊNG — hiện xong là DỪNG, chờ người dùng gõ** (Sếp bắt lỗi 22/07: *"sao mô tả không có thời gian để họ nhập vậy"*). Thẻ bấm và ô gõ tự do **không hiện cùng lúc được** — gọi thẻ ngay sau câu mở là cướp mất cơ hội gõ của họ, câu mở thành trang trí. Thứ tự đúng: `thẻ chọn hướng` → `các thẻ của nhánh` → **`câu mở → DỪNG chờ gõ`** → `thẻ cuối`.
...
0b. **Chi tiết checklist thiếu-đủ vẫn theo `references/chon-kieu-dung.md`** (file này tách riêng để dễ cập nhật — thêm/sửa câu hỏi thì sửa trong đó, không sửa SKILL.md): hỏi người dùng chọn 1 trong **3 KIỂU DỰNG**, rồi kiểm tra đã đủ nguyên liệu bắt buộc cho đúng kiểu đó chưa, thiếu gì hỏi ngay — đừng viết kịch bản khi còn thiếu mục bắt buộc. Tóm tắt 3 kiểu (chi tiết + checklist đầy đủ nằm trong file trên):
   ...
   **(5) LUÔN kèm một câu MỞ cuối cùng — mô tả buổi quay + đầu ra mong muốn** (Sếp Huy chốt 22/07/2026). Câu này **không bấm được**, phải để người dùng tự gõ, nên viết ngay dưới bảng thẻ chọn:

   > *"Sếp mô tả giúp tôi buổi quay này, và đầu ra Sếp mong muốn ra sao — càng cụ thể tôi càng làm đúng ý."*

   Đây là **thông tin quan trọng nhất của cả bước hỏi**: thẻ chọn chỉ quyết định khung kỹ thuật, câu này mới cho biết video phải **nói lên điều gì**. Bắt buộc **xử lý** chứ không đọc lướt — bóc ra bối cảnh · thông điệp · ràng buộc, đối chiếu với những gì máy đọc được từ footage, rồi **phản chiếu lại trong kịch bản trình duyệt**. Chi tiết cách xử lý: `references/chon-kieu-dung.md`, khối cuối file.

   ⚠️ **Công cụ hỏi giới hạn 4 thẻ mỗi lượt** — nên bố trí: 4 thẻ chọn (kiểu dựng · số video · kênh đăng · nhạc) + câu mở này viết bằng chữ ngay dưới. Đừng bỏ câu mở để nhét thêm thẻ.
